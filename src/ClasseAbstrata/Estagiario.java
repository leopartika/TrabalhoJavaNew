...
public class Estagiario extends Funcionario implements Trabalhavel{
    ...
    public String trabalhar() {
        return"O estagiário " + getNome() + " está trabalhando e tendo a supervisão de " + getSupervisor();
    }

    @Override
    public String relatarProgresso() {
        return"De acordo com o " + getSupervisor() + " o estagiário " + getNome() + " tem ido bem";
    }
